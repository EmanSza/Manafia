const { rect } = require('../utils/utils');
        ...
        module.exports = async (client, member) => { 
            let channel = guild.channels.cache.get('782642033940496454')
            if (!channel) return; 
            ...
            const userPicture = await loadImage(member.user.avatarURL(({ format: 'png' })));
            ...
            ctx.globalAlpha = 0.9;
            ctx.fillStyle = mainColour;
            const member_number = member.guild.memberCount;
